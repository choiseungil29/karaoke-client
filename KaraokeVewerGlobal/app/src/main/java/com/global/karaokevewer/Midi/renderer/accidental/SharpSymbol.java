package com.global.karaokevewer.Midi.renderer.accidental;
...
public class SharpSymbol extends Symbol {
    ...
    public SharpSymbol() {
        lineWidth = MidiInfo.LINE_STROKE;
        lineSpace = MidiInfo.LINE_SPACE_HEIGHT + MidiInfo.LINE_SPACE_HEIGHT/4;
