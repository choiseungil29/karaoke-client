...
public class TimeSignatureSymbol extends Symbol {
    ...
    public void draw(Canvas canvas) {
        ...
        Bitmap numerator = com.global.karaokevewer.Util.Resources.timeSignatureTable.get(time.getNumerator());
        Bitmap denominator = com.global.karaokevewer.Util.Resources.timeSignatureTable.get(time.getRealDenominator());
