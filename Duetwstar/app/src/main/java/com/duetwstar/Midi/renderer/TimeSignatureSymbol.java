...
public class TimeSignatureSymbol extends Symbol {
    ...
    public void draw(Canvas canvas) {
        ...
        Bitmap numerator = com.duetwstar.Util.Resources.timeSignatureTable.get(time.getNumerator());
        Bitmap denominator = com.duetwstar.Util.Resources.timeSignatureTable.get(time.getRealDenominator());
