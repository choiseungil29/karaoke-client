 ...
 * 화이트노트클래스는 말해준다 흰 키 노트인지, 샾이 없는지, 플랫니 없는지. 악보에 미디 노트로써 보여지고
 * 노트는 흰 키와 우연한?으로 변환되어진다 무라는거야 싀발
 *
 ...
 * 흰 노트는 A~G코드와 옥타브로 이루어져있다(0~10)
 * 옥타브는 G와 A사이에서 변한다. G2다음은 A3다 Middle-C는 C4에 해당.
 *
