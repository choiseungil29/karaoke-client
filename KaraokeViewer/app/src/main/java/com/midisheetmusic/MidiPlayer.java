...
public class MidiPlayer extends LinearLayout {
    ...
    public static void LoadImages(Context context) {
        ...
        rewindImage = BitmapFactory.decodeResource(res, R.mipmap.rewind);
        playImage = BitmapFactory.decodeResource(res, R.mipmap.play);
        pauseImage = BitmapFactory.decodeResource(res, R.mipmap.pause);
        stopImage = BitmapFactory.decodeResource(res, R.mipmap.stop);
        fastFwdImage = BitmapFactory.decodeResource(res, R.mipmap.fastforward);
        settingsImage = BitmapFactory.decodeResource(res, R.mipmap.settings);
    }
